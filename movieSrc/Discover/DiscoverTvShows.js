...
function DiscoverTvShows(props) {
    ...
    <ScrollView>
      ...
      <View style={{zIndex: -2}}>
        <LinearGradient
          ...
          <Text style={movieListStyle.text4}>Popular TV Shows</Text>
        </LinearGradient>
        <TVShowsInterface navigation={props.navigation} screenNumber={1} />
        ...
        <LinearGradient
          ...
          colors={['#01083d', 'skyblue']}>
          <Text style={movieListStyle.text4}>Top Rated TV Shows</Text>
        </LinearGradient>
        <TVShowsInterface navigation={props.navigation} screenNumber={3} />
        ...
        <LinearGradient
          ...
          style={{marginVertical: 2}}
          colors={['#01083d', 'skyblue']}>
          <Text style={movieListStyle.text4}>Airing Today TV Shows</Text>
        </LinearGradient>
        <TVShowsInterface navigation={props.navigation} screenNumber={2} />
        ...
        <LinearGradient
          ...
          colors={['#01083d', 'skyblue']}
          style={{marginVertical: 2}}>
          <Text style={movieListStyle.text4}>On the Air TV Shows</Text>
        </LinearGradient>

        <TVShowsInterface navigation={props.navigation} screenNumber={4} />
      </View>
      <View
        style={{
          height: 3,
